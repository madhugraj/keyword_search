...
def highlight_keywords(text, keywords):
    """
    Highlight keywords in the text by wrapping them in HTML <mark> tags with yellow background as per the instruction below:The keywords should be exactly(as an individul word and not inbetween words) mapped. For example if ett is the keyword, we should not highlight ett in getting, but ett should be highlighted in ett tested. 
    """
